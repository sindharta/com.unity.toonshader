...
#define UTS_OUTLINE_OBJECT_TO_WORLD GetObjectToWorldMatrix()
...
#undef UTS_OUTLINE_Z_OVERDRAW_SCALE
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float4 objPos = mul (UTSOutlineGetObjectToWorldMatrix(), float4(0,0,0,1) );
                ...
                float3 tangentDir;
                float3 bitangentDir;
                float3x3 tangentTransform = UTSOutlineBuildTangentFrame(v.normal, v.tangent, normalDir, tangentDir, bitangentDir);
                o.normalDir = normalDir;
                o.tangentDir = tangentDir;
                o.bitangentDir = bitangentDir;
